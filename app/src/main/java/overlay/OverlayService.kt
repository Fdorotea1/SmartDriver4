...
class OverlayService : Service() {
    ...
    private fun formatDuration(millis: Long): String { if (millis < 0) return "00:00:00"; val h = TimeUnit.MILLISECONDS.toHours(millis); val m = TimeUnit.MILLISECONDS.toMinutes(millis) % 60; val s = TimeUnit.MILLISECONDS.toSeconds(millis) % 60; return String.format(Locale.getDefault(), "%02d:%02d:%02d", h, m, s) }
